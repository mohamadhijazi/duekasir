        ...
        child: Column(
          children: <Widget>[
            UserAccountsDrawerHeader(
              ...
              accountName: Text(
                  '${auth.value?.user.value?.nama ?? "Hakim"} - ${auth.value?.user.value?.keterangan ?? "Market"}',
            ...
            ListTile(
              title: const Text('Selling-بيع'),
              leading: const Icon(Icons.sell_outlined),
              onTap: () => context.go('/'),
            ),
            ListTile(
              title: const Text('Report-تقرير'),
              leading: const Icon(Icons.home_repair_service_outlined),
              onTap: () => context.go('/report'),
            ),
            ListTile(
              title: const Text('Inventory-جرد'),
              leading: const Icon(Icons.inventory),
              onTap: () => context.go('/inventory'),
            ),
            // ListTile(
            //   title: const Text('Request-الطلبات'),
            ...
            // ),
            // ListTile(
            //   title: const Text('Due Payment-مستحق'),
            ...
            // ),
            ListTile(
              title: const Text('Customer-زبون'),
